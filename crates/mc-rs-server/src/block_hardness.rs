...
pub fn required_tool_type(block_name: &str) -> Option<ToolType> {
    match block_name {
        ...
        | "minecraft:jungle_planks"
        | "minecraft:acacia_planks"
        | "minecraft:dark_oak_planks" => Some(ToolType::Axe),
        "minecraft:dirt"
...
pub fn min_tool_tier_for_drop(block_name: &str) -> Option<ToolTier> {
    match block_name {
        ...
        "minecraft:iron_ore" | "minecraft:lapis_ore" | "minecraft:copper_ore" => {
            Some(ToolTier::Stone)
        }
        "minecraft:diamond_ore"
        | "minecraft:gold_ore"
        | "minecraft:redstone_ore"
        | "minecraft:emerald_ore"
        | "minecraft:deepslate" => Some(ToolTier::Iron),
        "minecraft:obsidian"
        | "minecraft:crying_obsidian"
        | "minecraft:respawn_anchor"
        | "minecraft:ancient_debris"
        | "minecraft:netherite_block" => Some(ToolTier::Diamond),
        _ => None,
    }
}
...
mod tests {
    ...
    fn obsidian_requires_diamond_pickaxe() {
        assert_eq!(
            min_tool_tier_for_drop("minecraft:obsidian"),
            Some(ToolTier::Diamond)
        );
        assert_eq!(
            required_tool_type("minecraft:obsidian"),
