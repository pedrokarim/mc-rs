...
pub fn all_mob_kinds() -> Vec<MobKind> {
    vec![
        MobKind::Chicken, MobKind::Cow, MobKind::Pig, MobKind::Sheep, MobKind::Rabbit,
        MobKind::Squid, MobKind::Villager, MobKind::Horse, MobKind::Donkey, MobKind::Llama,
        MobKind::Cat, MobKind::Wolf, MobKind::Ocelot, MobKind::Parrot, MobKind::Fox,
        MobKind::Panda, MobKind::Turtle, MobKind::Dolphin,
        MobKind::Zombie, MobKind::Skeleton, MobKind::Creeper, MobKind::Spider,
        MobKind::CaveSpider, MobKind::Enderman, MobKind::Witch, MobKind::Blaze,
        MobKind::Ghast, MobKind::MagmaCube, MobKind::Slime, MobKind::Drowned,
        MobKind::Husk, MobKind::Stray, MobKind::ZombieVillager, MobKind::WitherSkeleton,
        MobKind::ZombiePigman, MobKind::Wither, MobKind::EnderDragon,
        MobKind::Ravager, MobKind::Vindicator, MobKind::Pillager,
        MobKind::IronGolem, MobKind::SnowGolem,
    ]
}
