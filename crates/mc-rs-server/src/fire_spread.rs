...
pub fn flammability_for(block_id: u16) -> Flammability {
    match block_id {
        17 | 162 => Flammability { burn_chance: 5, spread_chance: 5 }, // wood logs
        5 | 125 | 126 => Flammability { burn_chance: 5, spread_chance: 20 }, // planks
        35 => Flammability { burn_chance: 30, spread_chance: 60 }, // wool
        18 | 161 => Flammability { burn_chance: 30, spread_chance: 60 }, // leaves
        37 | 38 | 39 | 40 => Flammability { burn_chance: 60, spread_chance: 100 }, // flowers/mushrooms
        31 | 175 => Flammability { burn_chance: 60, spread_chance: 100 }, // grass/tall grass
        85 | 107 => Flammability { burn_chance: 5, spread_chance: 20 }, // fences
        321 | 58 => Flammability { burn_chance: 5, spread_chance: 20 }, // painting / crafting table
        170 => Flammability { burn_chance: 60, spread_chance: 20 }, // hay bale
        _ => Flammability { burn_chance: 0, spread_chance: 0 },
    }
}
