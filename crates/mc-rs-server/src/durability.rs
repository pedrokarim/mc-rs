...
pub fn durable_info(item_network_id: i32) -> Option<DurableInfo> {
    ...
    let map = &[
        ("minecraft:wooden_pickaxe", ToolTier::Wood, ToolType::Pickaxe),
        ("minecraft:stone_pickaxe", ToolTier::Stone, ToolType::Pickaxe),
        ("minecraft:iron_pickaxe", ToolTier::Iron, ToolType::Pickaxe),
        ("minecraft:golden_pickaxe", ToolTier::Gold, ToolType::Pickaxe),
        ("minecraft:diamond_pickaxe", ToolTier::Diamond, ToolType::Pickaxe),
        ("minecraft:netherite_pickaxe", ToolTier::Netherite, ToolType::Pickaxe),
        ...
        ("minecraft:netherite_axe", ToolTier::Netherite, ToolType::Axe),
        ...
        ("minecraft:diamond_shovel", ToolTier::Diamond, ToolType::Shovel),
        ("minecraft:netherite_shovel", ToolTier::Netherite, ToolType::Shovel),
        ...
        ("minecraft:diamond_sword", ToolTier::Diamond, ToolType::Sword),
        ("minecraft:netherite_sword", ToolTier::Netherite, ToolType::Sword),
        ...
        ("minecraft:netherite_hoe", ToolTier::Netherite, ToolType::Hoe),
