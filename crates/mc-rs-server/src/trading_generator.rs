    ...
    match (profession, level) {
        ...
        (VillagerProfession::Farmer, 4) => vec![
            ...
            TradeTemplate {
                ...
                buy_a_count: 1,
                buy_b: None,
                sell: "minecraft:suspicious_stew",
                sell_count: 1,
                xp_player: 1,
                xp_villager: 15,
            },
        ...
        (VillagerProfession::Farmer, 5) => vec![
            ...
            TradeTemplate {
                ...
                buy_a_count: 4,
                buy_b: None,
                sell: "minecraft:glistering_melon_slice",
                sell_count: 3,
                xp_player: 1,
                xp_villager: 30,
            },
        ...
        (VillagerProfession::Librarian, 1) => vec![
            ...
            TradeTemplate {
                buy_a: "minecraft:emerald",
                buy_a_count: 9,
                buy_b: Some("minecraft:book"),
                sell: "minecraft:enchanted_book",
                sell_count: 1,
                xp_player: 1,
                xp_villager: 10,
            },
