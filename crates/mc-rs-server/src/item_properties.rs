...
pub fn max_stack_size(item_name: &str) -> u16 {
    match item_name {
        ...
        | "minecraft:golden_sword" | "minecraft:diamond_sword" | "minecraft:netherite_sword" => 1,
        "minecraft:wooden_pickaxe" | "minecraft:stone_pickaxe" | "minecraft:iron_pickaxe"
        | "minecraft:golden_pickaxe" | "minecraft:diamond_pickaxe" | "minecraft:netherite_pickaxe" => 1,
        "minecraft:wooden_axe" | "minecraft:stone_axe" | "minecraft:iron_axe"
        | "minecraft:golden_axe" | "minecraft:diamond_axe" | "minecraft:netherite_axe" => 1,
        "minecraft:wooden_shovel" | "minecraft:stone_shovel" | "minecraft:iron_shovel"
        | "minecraft:golden_shovel" | "minecraft:diamond_shovel" | "minecraft:netherite_shovel" => 1,
        "minecraft:wooden_hoe" | "minecraft:stone_hoe" | "minecraft:iron_hoe"
        | "minecraft:golden_hoe" | "minecraft:diamond_hoe" | "minecraft:netherite_hoe" => 1,
        "minecraft:leather_helmet" | "minecraft:leather_chestplate"
        | "minecraft:leather_leggings" | "minecraft:leather_boots" => 1,
        "minecraft:iron_helmet" | "minecraft:iron_chestplate"
        | "minecraft:iron_leggings" | "minecraft:iron_boots" => 1,
        "minecraft:chainmail_helmet" | "minecraft:chainmail_chestplate"
        | "minecraft:chainmail_leggings" | "minecraft:chainmail_boots" => 1,
        "minecraft:golden_helmet" | "minecraft:golden_chestplate"
        | "minecraft:golden_leggings" | "minecraft:golden_boots" => 1,
        "minecraft:diamond_helmet" | "minecraft:diamond_chestplate"
        | "minecraft:diamond_leggings" | "minecraft:diamond_boots" => 1,
        "minecraft:netherite_helmet" | "minecraft:netherite_chestplate"
        | "minecraft:netherite_leggings" | "minecraft:netherite_boots" => 1,
        "minecraft:bow" | "minecraft:crossbow" | "minecraft:trident" | "minecraft:fishing_rod" => 1,
        "minecraft:shears" | "minecraft:shield" | "minecraft:carrot_on_a_stick"
        ...
        "minecraft:lava_bucket" | "minecraft:water_bucket" | "minecraft:milk_bucket"
        | "minecraft:cod_bucket" | "minecraft:salmon_bucket" | "minecraft:axolotl_bucket"
        | "minecraft:tropical_fish_bucket" | "minecraft:pufferfish_bucket"
        | "minecraft:tadpole_bucket" => 1,
        "minecraft:oak_boat" | "minecraft:birch_boat" | "minecraft:spruce_boat"
        | "minecraft:jungle_boat" | "minecraft:acacia_boat" | "minecraft:dark_oak_boat"
        | "minecraft:mangrove_boat" | "minecraft:cherry_boat" => 1,
        ...
        "minecraft:honey_bottle" | "minecraft:potion" | "minecraft:lingering_potion"
        ...
        | "minecraft:banner" | "minecraft:sign" => 16,
        // Default = 64
        _ => 64,
    }
}
